...
public class Main{
    ...
    private static String
            scapiVersion = "4.7.1", // <-- Update if there is a new SCAPI Update
            spigotVersion = "1.16.4-R0.1-SNAPSHOT",  // <-- Update if there is a new spigot version
            bungeeVersion = "1.16-R0.4-SNAPSHOT"; // <-- Update if there is a new bungee version
    ...
    private static boolean requestVersions(){
        ...
        String bungeeMetadata = "https://repo.md-5.net/repository/public/net/md-5/bungeecord-api/maven-metadata.xml";
        try{
